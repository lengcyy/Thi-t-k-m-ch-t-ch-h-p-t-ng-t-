...
Vin1_n = subs(Vin1_syms,[Vdd Rd kn Vth],[Vdd_0, Rd_0, kn_0, Vth_0]);% Symbolic substitution
...
Vout_tri_n = subs(Vout_tri(2),[Vdd Rd kn Vth],[Vdd_0, Rd_0, kn_0, Vth_0]);
